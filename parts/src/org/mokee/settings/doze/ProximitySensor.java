...
public class ProximitySensor implements SensorEventListener {
    ...
    // Maximum time for the hand to cover the sensor: 0.3s
    private static final int HANDWAVE_MAX_DELTA_NS = 300 * 1000 * 1000;

    // Minimum time until the device is considered to have been in the pocket: 1s
    private static final int POCKET_MIN_DELTA_NS = 1000 * 1000 * 1000;
